 ...
 * @return result of the test, a combination of flags F_HEX and F_BASE32
 */
 ...
 * @param filename pointer to receive parsed filename
 * @param sums buffer to receive parsed sums
